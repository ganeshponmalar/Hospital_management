...
// Admission Routes
router.post('/admissions/admit', verifyToken, authorize(['doctor']), admissionController.admitPatient);
router.post('/admissions/discharge', verifyToken, authorize(['doctor']), admissionController.dischargePatient);
